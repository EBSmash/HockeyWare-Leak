...
public class HUD extends Module {
    ...
    public static final Setting<Boolean> direction = new Setting<>("Direction", false);
...
//    public static final Setting<Boolean> playersOnly = new Setting<>("PlayersOnly", true);
    public static final Setting<BracketColor> bracketColor = new Setting<>("BracketColor", BracketColor.Red);
 ...
 */
    ...
    public void onRender2D() {
        ...
        if (watermark.getValue()) {
            Globals.mc.fontRenderer.drawStringWithShadow(HockeyWare.NAME + " v" + HockeyWare.VERSION, 2.0f, 2.0f, TEXT_COLOR());
        }
