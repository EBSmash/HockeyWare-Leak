...
public class ClientMessage implements Globals {
    ...
    private static String opener() {
        return ColorUtil.getBracketColorFromSetting(HUD.bracketColor.getValue()) + "[" + ColorUtil.getNameColorFromSetting(HUD.nameColor.getValue()) + HockeyWare.NAME + ColorUtil.getBracketColorFromSetting(HUD.bracketColor.getValue()) + "] " + ChatFormatting.RESET;
    }

    private static String moduleOpener(String moduleName) {
        return ColorUtil.getBracketColorFromSetting(HUD.bracketColor.getValue()) + "[" + ColorUtil.getNameColorFromSetting(HUD.nameColor.getValue()) + HockeyWare.NAME + ColorUtil.getBracketColorFromSetting(HUD.bracketColor.getValue()) + "] " + ChatFormatting.WHITE + "[" + moduleName + "] " + ChatFormatting.RESET;
    }
